...
class _EditTextDlgState extends State<EditTextDlg> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.textEditingControllerUserName!.text = widget.name;
    widget.textEditingControllerDescription!.text = widget.description;
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: EditTextFieldRound(
              ...
              isPassword: false,
              isSecure: false,
              mController: widget.textEditingControllerUserName!,
          ...
          Container(
            ...
            child: EditTextFieldRound(
              ...
              isPassword: false,
              isSecure: false,
              mController: widget.textEditingControllerDescription!,
              borderColor: ColorUtils.appColorBlack_50,
              textColor: ColorUtils.appColorBlack,
              hintColor: ColorUtils.appColorBlack_50,
              borderRadius: 5,
                ...
                child: RoundButton(
                  ...
                  onPressed: () {
                    if (widget.onClickSave != null &&
                        widget.textEditingControllerUserName!.text.isNotEmpty &&
                        widget
                            .textEditingControllerDescription!
                            .text
                            .isNotEmpty) {
                      widget.onClickSave!(
                        widget.textEditingControllerUserName!.text,
                        widget.textEditingControllerDescription!.text,
                      );
                    }
                    finishView(context);
                  },
